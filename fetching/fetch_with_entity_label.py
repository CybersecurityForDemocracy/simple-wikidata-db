"""
This script fetches entity label by entity ID (ie Q2)
...
def get_arg_parser():
    ...
    parser.add_argument('--qid', type = str, default='Q2', help ='entity ID')
...
def main():
    ...
    for output in tqdm(
        pool.imap_unordered(
            partial(filtering_func, args.qid), table_files, chunksize=1), 
